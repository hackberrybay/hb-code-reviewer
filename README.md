...
```
/plugin marketplace add https://raw.githubusercontent.com/hackberrybay/hb-code-reviewer/main/.claude-plugin/marketplace.json
```

```
/plugin install hb-code-reviewer@hb-marketplace
```
